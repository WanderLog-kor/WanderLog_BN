...
- **WanderLog** 는 여행을 갈 때 계획을 생성할 때, 다른 사람들의 정보를 참고해 나만의 여행계획을 만들 수 있게 하는 국내여행 웹사이트입니다.
...
## ▶️ 개발 동기 및 주요기능
일에 지치고 사람들에게 치이는 현대인들을 위해 빠르고 간편하게 여행을 계획 할 수 있도록 WanderLog를 개발하게 되었습니다.

- ### 본인만의 여행 계획을 만들자 <br>
  WanderLog에서는 본인만의 여행 플래너를 계획할 수 있습니다.<br>
